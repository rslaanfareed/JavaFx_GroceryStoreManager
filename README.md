...
This is a GUI-based upgrade of the original C++ console app. Built entirely in Java using JavaFX for the interface and external CSS for styling — no inline styles.
